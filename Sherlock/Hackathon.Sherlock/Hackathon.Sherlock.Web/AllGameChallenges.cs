...
namespace Hackathon.Sherlock.Web
{
    public static class AllGameChallenges
    {
        ...
        { 
         ...
         new GameRound { Category = Category.City, Challenge="This Arabian Gulf Emirate has the tallest building in the world", CorrectResponse="Dubai", Reward=400, Used=false } ,
