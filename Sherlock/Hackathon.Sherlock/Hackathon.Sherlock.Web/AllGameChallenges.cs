...
namespace Hackathon.Sherlock.Web
{
    public static class AllGameChallenges
    {
        ...
        { 
         ...
         new GameRound { Category = Category.Person, Challenge="This person from Kansas City created Hallmark", CorrectResponse="Joyce Hall", Reward=600, Used=false} ,
         ...
         new GameRound { Category = Category.City, Challenge="This city has the tallest building in the world", CorrectResponse="Dubai", Reward=400, Used=false } ,
         new GameRound { Category = Category.City, Challenge="This river is the longest in the world", CorrectResponse="Nile" , Reward=200, Used=false} ,
         ...
         new GameRound { Category = Category.City, Challenge="The \"Hand of God\" goal happened in a soccer world cup in this city", CorrectResponse="Mexico City", Reward=800, Used=false }
        };
    }
}